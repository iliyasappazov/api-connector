...
export default class ApiConnector {
  ...
  reqPost(url, data = undefined, params = {}, configs = {}) {
    return this.request({
      method: 'POST', url, data, params, ...configs,
    });
  }
  ...
  reqPatch(url, data, params = {}, configs = {}) {
    return this.request({
      method: 'PATCH', url, data, params, ...configs,
    });
  }
  ...
  reqPut(url, data = undefined, params = {}, configs = {}) {
    return this.request({
      method: 'PUT', url, data, params, ...configs,
    });
  }
  ...
  reqDelete(url, params = {}, configs = {}) {
    return this.request({
      method: 'DELETE', url, params, ...configs,
    });
  }
