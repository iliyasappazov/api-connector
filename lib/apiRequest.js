...
export default class ApiRequest {
    ...
    startSingle(identifier = "") {
        ...
        if (this.pendingRequests[info]) {
            for (let prId in this.pendingRequests[info]) {
                if (this.pendingRequests[info].hasOwnProperty(prId)) {
                    this.pendingRequests[info][prId]();    // cancel request
                }
            }
        } else {
